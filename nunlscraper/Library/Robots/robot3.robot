    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="3">
        ...
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ValueURLProvider2">
            <property name="URL" class="String">www.nu.nl</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="5">
        ...
        <property name="stepAction" class="ForEachTagPath" serializationversion="0">
          ...
          <property name="classes" class="String">list-overlay</property>
        </property>
      ...
      <object class="Transition" serializationversion="3" id="7">
        ...
        <property name="stepAction" class="ReturnVariable" serializationversion="1">
          <property name="variableName" class="kapow.robot.plugin.common.support.VariableName">
            <property name="name" class="String">newsitem</property>
          </property>
        </property>
