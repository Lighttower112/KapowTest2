...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <referenced-snippets>
      <snippet name="ExtractNewsItem"/>
    </referenced-snippets>
    <typed-variables>
      <typed-variable name="newsitem" type-name="newsitem"/>
    </typed-variables>
    <global-variables/>
    <parameters/>
    <return-variables/>
  ...
  <property name="variables" class="Variables">
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="0">newsitem</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
          <property name="typeName" class="String">newsitem</property>
        </property>
      </property>
    </object>
  </property>
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="4">
        ...
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ValueURLProvider2">
            <property name="URL" class="String">http://www.nu.nl</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="6">
        ...
        <property name="stepAction" class="ForEachTagPath" serializationversion="0">
          ...
          <property name="classes" class="String">info</property>
          <property name="tagName" class="DesiredElementName">
            <property name="name" class="String">infoblock</property>
          </property>
        </property>
      ...
      <object class="SnippetStep" id="7">
        ...
        <snippetName class="String">ExtractNewsItem</snippetName>
        <snippetStepComment>
          <null/>
        </snippetStepComment>
      </object>
